  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-blue-50 dark:from-gray-900 dark:via-purple-900 dark:to-blue-900">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Demo Data Notice */}
        {!hasRealData && (
          <Card className="mb-8 backdrop-blur-sm bg-blue-100/80 dark:bg-blue-500/10 border-blue-300 dark:border-blue-500/50">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-700 dark:text-gray-300">
                    ...
                    <Link href="/connect" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
                      Connect page
                    </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {stats.map((stat) => {
            ...
            return (
              <Card 
                key={stat.title} 
                className="relative overflow-hidden backdrop-blur-sm bg-white/50 dark:bg-gray-800/50 border-gray-300 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
        ...
        {/* Streak Card */}
        <Card className="mb-8 backdrop-blur-sm bg-white/50 dark:bg-gray-800/50 border-gray-300 dark:border-gray-700 shadow-lg">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
        ...
        <Card className="mb-8 backdrop-blur-sm bg-gradient-to-br from-purple-100/80 to-blue-100/80 dark:from-purple-500/20 dark:to-blue-500/20 border-purple-300 dark:border-purple-500/50 shadow-lg relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-200/20 to-cyan-200/20 dark:from-purple-600/10 dark:to-cyan-600/10 animate-pulse"></div>
          <CardHeader className="relative z-10">
            <CardTitle className="text-3xl text-gray-900 dark:text-white flex items-center gap-2">
              <Zap className="h-8 w-8 text-yellow-500 dark:text-yellow-400" />
              🎯 Audience Challenge
            </CardTitle>
            <CardDescription className="text-gray-700 dark:text-gray-300 text-lg">
              Witness BlockDAG&apos;s 10,000+ TPS! Mint 200 credentials instantly.
            </CardDescription>
          </CardHeader>
          <CardContent className="relative z-10 space-y-4">
            {isMinting && (
              <div className="p-6 rounded-lg bg-white/80 dark:bg-gray-900/50 border border-purple-400 dark:border-purple-500/50">
                <div className="text-center">
                  <div className="text-6xl font-bold bg-gradient-to-r from-purple-600 to-cyan-600 dark:from-purple-400 dark:to-cyan-400 bg-clip-text text-transparent mb-2">
                    {mintCount}
                  </div>
                  <p className="text-gray-600 dark:text-gray-400">credentials minted</p>
                </div>
                <div className="mt-4 w-full bg-gray-300 dark:bg-gray-800 rounded-full h-4 overflow-hidden">
                  <div 
        ...
        <Card className="mb-8 backdrop-blur-sm bg-white/50 dark:bg-gray-800/50 border-gray-300 dark:border-gray-700 shadow-lg">
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/80 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-2">
                  <Award className="h-5 w-5 text-yellow-500 dark:text-yellow-400" />
                  <h3 className="font-semibold text-gray-900 dark:text-white">30-Day Step Challenge</h3>
                </div>
              ...
              <div className="p-4 rounded-lg bg-white/80 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-700">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white">Heart Health Week</h3>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-gradient-to-r from-red-600 to-pink-600 text-white">
                    Join Now
                  </Button>
                </div>
              </div>
        ...
        <Card className="backdrop-blur-sm bg-white/50 dark:bg-gray-800/50 border-gray-300 dark:border-gray-700 shadow-lg">
          ...
          <CardContent>
            <div className="aspect-video rounded-lg overflow-hidden border border-gray-300 dark:border-gray-700">
              <iframe
